...
var i18n = {
  ...
  'ru': {
    ...
    'Anniversaries today': 'Юбилеи сегодня',
    'Anniversaries tomorrow': 'Юбилеи завтра',
    'Anniversaries in {0} days': 'Юбилеи через {0} дней',
    'Custom events today': 'Другие события сегодня',
    'Custom events tomorrow': 'Другие события завтра',
    'Custom events in {0} days': 'Другие события через {0} дней',
    'Hey! Don\'t forget these events': 'Привет! Не забудь об этих событиях',
    'version': 'версия',
    'dd-MM-yyyy': 'dd-MM-yyyy',
    ...
    'Google voice': 'Google voice',
    'Pager': 'Пейджер',
    'Home email': 'Личный email',
    'Work email': 'Рабочий email',
    'Other email': 'Другой email',
    'It looks like you are using an outdated version of this script': 'Кажется, вы используете устаревшую версию скрипта',
